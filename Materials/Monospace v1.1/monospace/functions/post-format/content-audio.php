...
<?php $featuredImgClass = !get_the_post_thumbnail() ? "no-image" : "has-image"; ?>
		...
		<div class="latest-post-data">
			<div class="top-row">
				<?php if(isset($mts_options['mts_home_headline_meta']) == '1') { ?>
					...
					<?php } ?>
				<?php } ?>
				<span class="post-format-icon icon-volume-up"></span>				
			</div>
		...
		<?php if ( get_the_post_thumbnail() ) { ?>
			<div class="latest-post-img">
				<a href="<?php the_permalink() ?>" title="<?php the_title(); ?>" rel="nofollow" id="featured-thumbnail">				
					<?php echo '<div class="">'; the_post_thumbnail('featured3',array('title' => '')); echo '</div>'; ?>				
				</a>
			</div>
		<?php } ?>
	</div>
