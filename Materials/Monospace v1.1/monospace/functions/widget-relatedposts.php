...
class mts_related_posts_widget extends WP_Widget {
	...
	public function upauthor( $new_instance, $old_instance ) {
		$instance = array();
	...
	public function widget( $args, $instance ) {
		...
		if(is_singular()){
			...
			echo self::get_cat_posts( $qty, $comment_num, $author, $show_thumb6, $show_excerpt, $excerpt_length );
			echo $after_widget;
		}
	}

	public function get_cat_posts( $qty, $comment_num, $author, $show_thumb6, $show_excerpt, $excerpt_length ) {
	global $post;
	$thePostID = $post->ID;
