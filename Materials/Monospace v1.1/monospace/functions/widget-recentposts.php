...
class mts_recent_posts_widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		echo self::get_cat_posts( $qty, $comment_num, $author, $show_thumb2, $show_excerpt, $excerpt_length );
		echo $after_widget;
	}

	public function get_cat_posts( $qty, $comment_num, $author, $show_thumb2, $show_excerpt, $excerpt_length ) {
		$posts = new WP_Query(
